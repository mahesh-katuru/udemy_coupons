  ...
  return (
    <div className="relative min-h-screen bg-white">
      ...
      <div className="pt-30 md:pt-20"> {/* Adjusted padding to prevent content from hiding behind navbar */}
        <Routes>
          <Route exact  path="/udemy_coupons/" element={<Home />} />
          <Route exact path="/udemy_coupons/description/:id" element={<Coupondescription />} />
          <Route exact path="/udemy_coupons/category/:category" element={<CategoryCoupons />} />
          <Route path="*" element={<PageNotFound />} />
        </Routes>
      </div>
      <Footer />
